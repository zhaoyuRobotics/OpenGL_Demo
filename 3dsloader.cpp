...
char Load3DS (obj_type_ptr p_object, char *p_filename)
{
    ...
    unsigned short l_qty; //Number of elements in each chunk 每个块中的元素数

    unsigned short l_face_flags; //Flag that stores some face information 保存一些面部信息的标志
